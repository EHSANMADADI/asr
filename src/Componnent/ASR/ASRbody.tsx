        ...
        {savedRecordings.length > 0 ? (
          <>
            ...
            <div className="border-b-2 w-1/2 mx-auto border-gray-600 max-h-[70vh] overflow-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-blue-300">
              {savedRecordings.map(
                (item: { name: string; audio: string ,language:string }, index: number) => (
                  <div className="mt-2 mb-3" key={index}>
                    ...
                    <div className="flex items-center">
                      ...
                      {converting[index] ? (
                       ...
                       <span className="text-bold text-lg p-2 border-2 border-black border-dashed rounded-md">{item.language}</span>
                    </div>
                    <div className="w-1/2">
                      <Modal
